...
title: "클래스"
pubDate: 2023-01-13
description: "ES5까지는 생성자 함수를 이용해서 클래스를 정의했지만, ES6부터는 클래스 문법을 제공하기 때문에 클래스 문법을 사용해서 작성하면 된다. 하지만, 클래스 문법을 제공한다고 해서 프로토타입의 언어에서 클래스를 기반으로 한 언어로 바뀐 것은 아니고 새로운 인스턴스 생성 ..."
tags: ["JavaScript"]
heroImage: "https://velog.velcdn.com/images/crowwan/post/531fdc0c-0c94-47ba-94ce-a080f2b3d470/image.png"
---

![](https://thumbs.gfycat.com/SizzlingHeartfeltAfricanmolesnake-size_restricted.gif)
## 클래스
